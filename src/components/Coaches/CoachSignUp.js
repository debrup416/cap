...
const CoachSignUp = () => {
  ...
  const addCoach = (event) => {
    ...
    console.log(coachData);
     let x=(validateGender(coachData.gender) && validateName(coachData.name)  && ValidatePass(coachData.password)  &&
     validateMobile(coachData.mobileNumber) && validateSpeciality(coachData.speciality) && 
